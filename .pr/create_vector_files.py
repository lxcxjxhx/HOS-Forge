"""Script to create vector search module files."""
import os

BASE = 'hosforge/knowledge'

# vector_store.py
vs = '''"""Vector store module using FAISS for similarity search."""
...
# search.py
sr = '''"""Semantic search API for knowledge base."""
...
# indexer.py
ix = '''"""Index builder and persistence for knowledge base."""
...
for fname, content in [('vector_store.py', vs), ('search.py', sr), ('indexer.py', ix)]:
