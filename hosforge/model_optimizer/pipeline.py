...
class PipelineExecutor:
    ...
    def _execute_merge(self):
        ...
        merge_model(
            base_model_path=cfg.base_model, adapter_path=adapter_path, output_path=cfg.output
        )
    ...
    def _execute_upload(self):
        ...
        upload_to_huggingface(model_path=model_path, repo_id=cfg.repo_id, private=cfg.private)
